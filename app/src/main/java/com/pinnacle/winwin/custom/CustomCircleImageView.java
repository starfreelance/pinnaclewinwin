...
public class CustomCircleImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public CustomCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCircleBackgroundColor = a.getColor(R.styleable.CustomCircleImageView_civ_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
    ...
    public void setBorderColor(@ColorInt int borderColor) {
        ...
        mBorderPaint.setShader(Utils.getTextGradient(new int[]{ASOnlineApplication.getInstance().getApplicationContext().getResources().getColor(R.color.colorStartGold),
